    ...
    },
    {
      ...
      cell: (branch: Branch) => (
        <div className="flex items-center gap-2">
          ...
          <span className="font-medium text-sm">{branch.student_count || 0}</span>
        </div>
      )
    },
    {
      ...
      cell: (branch: Branch) => (
        <div className="flex items-center gap-2">
          ...
          <span className="font-medium text-sm">{branch.teacher_count || 0}</span>
        </div>
      )
    },
    {
  ...
  return (
    <div className="space-y-8">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-display font-bold text-foreground">Branches</h1>
          <p className="text-muted-foreground mt-1">Overview and management of all school campuses.</p>
        </div>
        ...
        <div className="bg-primary/5 p-3 rounded-2xl flex items-center gap-3 border border-primary/10">
          ...
          <div>
            <div className="text-2xl font-bold leading-none">{branches.filter(b => b.status === 'Active').length}</div>
            <div className="text-[10px] uppercase font-bold tracking-wider text-muted-foreground">Active Branches</div>
          </div>
        </div>
      </div>
      ...
      <DataTable 
        ...
        onAddClick={() => navigate('/admin/branches/add')}
      />
