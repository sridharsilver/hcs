  ...
  return (
    <div className="max-w-5xl mx-auto space-y-8">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-display font-bold text-foreground">Add New Branch</h1>
          <p className="text-muted-foreground mt-1">Fill in the details to create a new school campus.</p>
        </div>
      </div>

      <div className="bg-card p-8 rounded-3xl shadow-card border border-border/50">
        <BranchForm onSubmit={onSubmit} isLoading={isLoading} />
      </div>
    </div>
  );
};
